...
if (!isset($_SESSION['admin'])) 
{
    ...
    echo "<scrpt>location='login.php;</script>";
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li><a href="index.php?halaman=obat"><i class="fa fa-cube"></i> Obat</a></li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                if (isset($_GET['halaman'])) 
                {
                    ...
                    elseif ($_GET['halaman']=="tambahobat")
                    {
                    ...
                    elseif ($_GET['halaman']=="hapusobat")
                    {
                        include 'hapusobat.php';
                    }
                    elseif ($_GET['halaman']=="ubahobat")
                    {
                        include 'ubahobat.php';
                    }
